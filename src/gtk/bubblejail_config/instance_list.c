...
static GtkHeaderBar *create_instace_selection_header()
{
...
static BubblejailInstanceList create_instance_list()
{
...
static BubblejailInstanceListItem create_instance_list_entry(const gchar *label_text, const gchar *icon_name)
{
    if (icon_name == NULL)
    {
...
static void instance_list_insert(BubblejailInstanceList instance_list, BubblejailInstanceListItem new_item)
{
...
void show_instance_list(GtkWindow *main_window)
{
    ...
    instance_list_insert(instance_list, create_instance_list_entry("test", NULL));
